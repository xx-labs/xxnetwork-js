...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    claims: {
      claims: AugmentedQuery<ApiType, (arg: ClaimsEthereumAddress | string | Uint8Array) => Observable<Option<u128>>, [ClaimsEthereumAddress]> & QueryableStorageEntry<ApiType, [ClaimsEthereumAddress]>;
      /**
       * Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
       **/
      preclaims: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ClaimsEthereumAddress>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Proposed amount of BetaNet staking rewards
       **/
      rewards: AugmentedQuery<ApiType, (arg: ClaimsEthereumAddress | string | Uint8Array) => Observable<Option<u128>>, [ClaimsEthereumAddress]> & QueryableStorageEntry<ApiType, [ClaimsEthereumAddress]>;
      /**
       * The statement kind that must be signed, if any.
       **/
      signing: AugmentedQuery<ApiType, (arg: ClaimsEthereumAddress | string | Uint8Array) => Observable<Option<ClaimsStatementKind>>, [ClaimsEthereumAddress]> & QueryableStorageEntry<ApiType, [ClaimsEthereumAddress]>;
       ...
       **/
      vesting: AugmentedQuery<ApiType, (arg: ClaimsEthereumAddress | string | Uint8Array) => Observable<Option<Vec<ITuple<[u128, u128, u32]>>>>, [ClaimsEthereumAddress]> & QueryableStorageEntry<ApiType, [ClaimsEthereumAddress]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<XxnetworkRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, XxnetworkRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    staking: {
       ...
       **/
      cmixIds: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Null>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       ...
       * Election is active.
       **/
      electionActive: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    swap: {
       ...
       **/
      feeDestination: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Swap service fee charged when moving native tokens out of the chain
       **/
      swapFee: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xxBetanetRewards: {
       ...
       * Store user info
       **/
      accounts: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<XxBetanetRewardsUserInfo>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Store if the rewards program is approved
       **/
      approved: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xxCmix: {
       ...
       **/
      adminPermission: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Cmix user ephemeral reception IDs address space size in bits
       **/
      cmixAddressSpace: AugmentedQuery<ApiType, () => Observable<u8>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Cmix software hashes
       **/
      cmixHashes: AugmentedQuery<ApiType, () => Observable<XxCmixCmixSoftwareHashes>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Current cmix variables
       **/
      cmixVariables: AugmentedQuery<ApiType, () => Observable<XxCmixCmixVariables>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Next cmix variables
       **/
      nextCmixVariables: AugmentedQuery<ApiType, () => Observable<Option<XxCmixCmixVariables>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Scheduling server account
       **/
      schedulingAccount: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xxCustody: {
       ...
       **/
      custodians: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Null>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Keep track of custody accounts
       **/
      custodyAccounts: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Null>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Keep track of team members'accounts custody info
       **/
      teamAccounts: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<XxTeamCustodyCustodyCustodyInfo>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Total amount under custody
       **/
      totalCustody: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xxEconomics: {
       ...
       **/
      idealLiquidityStake: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Inflation fixed parameters: minimum inflation, ideal stake and curve falloff
       **/
      inflationParams: AugmentedQuery<ApiType, () => Observable<XxEconomicsInflationInflationFixedParams>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * List of ideal interest points, defined as a tuple of block number and idea interest
       **/
      interestPoints: AugmentedQuery<ApiType, () => Observable<Vec<XxEconomicsInflationIdealInterestPoint>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Liquidity rewards balance
       **/
      liquidityRewards: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xxPublic: {
       ...
       **/
      saleManager: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Testnet Manager account
       **/
      testnetManager: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
